...
import com.study.queryDSL.util.QueryDslUtil;
    ...
    public Page<MemberTeamDto> searchPageSimple(MemberSearchCondition condition,
        ...
        QueryResults<MemberTeamDto> results = jpaQueryFactory
                ...
                .where(usernameEq(condition.getUsername()),
                        ...
                        ageGoe(condition.getAgeGoe()),
                        ageLoe(condition.getAgeLoe()))
                .orderBy(ORDERS.stream().toArray(value -> new OrderSpecifier[value]))
        ...
        if (!isEmpty(pageable.getSort())) {
            for (Sort.Order order : pageable.getSort()) {
                ...
                switch (order.getProperty()) {
                    case "username":
                        OrderSpecifier<?> orderUsername = QueryDslUtil.getSortedColumn(direction, member, "username");
                        ORDERS.add(orderUsername);
                        break;
                    case "name":
                        OrderSpecifier<?> orderTeamName = QueryDslUtil.getSortedColumn(direction, team, "name");
                        ORDERS.add(orderTeamName);
                        break;
                    case "age":
                        OrderSpecifier<?> orderAge = QueryDslUtil.getSortedColumn(direction, member, "age");
                        ORDERS.add(orderAge);
                        break;
                    default:
                        break;
