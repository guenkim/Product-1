...
public class InterfaceException extends BaseException{
    ...
    public InterfaceException(String systemMessage,Throwable cause, boolean enableSuppression, boolean writableStackTrace , String userMessage){
    ...
    public static BaseExceptionBuilder withUserMessage(String strUserMessageFormat, Object... objArgs){
        return InterfaceException.withUserMessage(BaseExceptionBuilder.formatMessage(strUserMessageFormat,objArgs));
    }
    ...
    public static BaseExceptionBuilder withSystemMessage(String strSystemMessageFormat , Object... objArgs){
        return InterfaceException.withSystemMessage(BaseExceptionBuilder.formatMessage(strSystemMessageFormat,objArgs));
    }
